<template>
  ...
  >
    ...
    <div>
      ...
      >
        <div class="flex items-center pb-5 gap-2">
        ...
        >
          <div class="flex justify-between">
            ...
            <div class="p-3 flex flex-col gap-5">
              <p class="font-medium text-justify">{{ danger.desc }}</p>
              <CodeTemplate
                v-if="danger.code"
      ...
      <div
        v-if="card.exploits"
        class="flex items-center justify-between gap-2 pt-7 pb-3"
      >
        <div class="flex items-center gap-2">
      ...
      <div class="flex items-center justify-between gap-2 pt-7 pb-3">
        <div class="flex items-center gap-2">
      ...
      >
        ...
        >
          <div class="flex justify-between">
            ...
            <div class="p-3 flex flex-col gap-5">
              <p class="font-medium text-justify">{{ decision.desc }}</p>
              <CodeTemplate
                v-if="decision.code"
                class="p-6 bg-[#2F3035] text-[--grey]"
                language="JavaScript"
              />
            </div>
          </div>
